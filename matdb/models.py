...
class Family(str, Enum):
    ...
    PU_1K_WB = "pu_1k_wb"
    """Однокомпонентный полиуретан на водной основе. Плёнка образуется
    испарением воды, поэтому ограничения по влажности и морозу принципиально
    иные, чем у влагоотверждаемого полиуретана."""
    PU_BITUMEN = "pu_bitumen"
    """Битум-модифицированный (битум-наполненный) полиуретан. Выделен в
    отдельное семейство, потому что ведёт себя на стыках иначе обычного ПУ:
    рассчитан на нанесение по битуму, но сам несёт битумную составляющую,
    способную мигрировать в слои над ним."""
    PU_2K = "pu_2k"
    PU_CEMENT = "pu_cement"
    EPOXY_2K = "epoxy_2k"
    EPOXY_WB = "epoxy_wb"
